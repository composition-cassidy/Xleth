...
// Minimal store for the Transient Processor panel — tracks which effect instance is open.
// Parameter reads/writes go directly via window.xleth.audio (generic N-API).

const useTransientProcStore = create((set) => ({
...
export default useTransientProcStore
