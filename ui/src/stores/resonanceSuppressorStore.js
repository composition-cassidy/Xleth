...
// Minimal store for the Resonance Suppressor panel — tracks which effect instance is open.
// Parameter reads/writes go directly via window.xleth.audio (generic N-API).

const useResonanceSuppressorStore = create((set) => ({
...
export default useResonanceSuppressorStore
