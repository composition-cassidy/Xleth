...
export const BAND_MODES = ['Normal', 'Dynamic', 'Spectral']
...
const useEqStore = create((set, get) => ({
  ...
  open(trackId, nodeId, storeKey) {
    set({ target: { trackId, nodeId, storeKey }, bands: [], responseCurve: null, spectrumData: null, bandGR: null, linPhase: false, oversample: 0, preSpectrum: false, sampleRate: 44100 })
    get().fetchBands()
  ...
  close() {
    set({ target: null, bands: [], responseCurve: null, spectrumData: null, bandGR: null, linPhase: false, oversample: 0, preSpectrum: false, sampleRate: 44100 })
  },
