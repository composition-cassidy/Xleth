      ...
      whites.push(
        <div
          ...
          style={{
            ...
            width: WHITE_KEY_W - 1,
            height: KEY_H,
            background: isRoot ? 'var(--theme-label-pitch)' : '#EAEAF0',
            color: isRoot ? '#0a0a10' : '#333',
            borderRadius: '0 0 3px 3px',
            borderRight: '1px solid var(--theme-sampler-key-border)',
            display: 'flex',
            alignItems: 'flex-end',
      ...
      blacks.push(
        <div
          ...
          style={{
            ...
            height: KEY_H * 0.6,
            background: isRoot ? 'var(--theme-label-pitch)' : 'var(--theme-bg-surface)',
            color: isRoot ? '#0a0a10' : '#888',
            borderRadius: '0 0 3px 3px',
            border: '1px solid var(--theme-sampler-key-black)',
            zIndex: 2,
            cursor: 'pointer',
            userSelect: 'none',
            display: 'flex',
