...
const LFO_COLOR_TOKENS = { vol: '--theme-sampler-mod-color-volume', pan: '--theme-sampler-mod-color-pan', pitch: '--theme-sampler-mod-color-pitch' }
const LFO_BG_TOKENS    = { vol: '--theme-sampler-mod-bg-volume',    pan: '--theme-sampler-mod-bg-pan',    pitch: '--theme-sampler-mod-bg-pitch' }
