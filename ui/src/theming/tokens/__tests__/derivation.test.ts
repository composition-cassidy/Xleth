...
describe('deriveTheme — structural contracts', () => {
  it('produces every §3.2 formula token (warning/success excluded — class C)', () => {
    ...
    const expected = [
      ...
      '--theme-panel-grid',
      '--theme-panel-node',
      // Accent-relative tokens migrated from explicit catalog defaults
      '--theme-accent-bg-subtle',
      '--theme-accent-bg-medium',
      '--theme-snap-ghost-fill',
      '--theme-snap-ghost-border',
      '--theme-pianoroll-note-slide-stroke',
      '--theme-pianoroll-loop-region',
      '--theme-pianoroll-selection-rect',
      '--theme-sampler-mod-color-volume',
      '--theme-timeline-selection-rect',
      '--theme-grid-chorus-overlay',
      '--theme-nodeeditor-selection-rect',
      '--theme-projectmedia-dropzone',
      '--theme-eq-band-1',
      '--theme-eq-response-fill',
      '--theme-dyn-transfer-fill',
      '--theme-dyn-transient-sustain-fill',
      '--theme-filter-response-fill',
      '--theme-dist-waveshape-fill',
      '--theme-syllable-accent-light',
      '--theme-syllable-section-alt',
      '--theme-lipsync-selection-fill',
      '--theme-waveform-envelope-fill',
      '--theme-waveform-rms-body',
    ];
