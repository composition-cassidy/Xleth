...
export const TOKENS: ReadonlyArray<TokenDef> = [
  ...
  explicit('--theme-timeline-clip-waveform-fg', 'rgba(255, 255, 255, 0.92)', 'solid', 'Workspace panels', 'timeline'),
  explicit('--theme-timeline-clip-waveform-bg', 'rgba(0, 0, 0, 0.52)', 'solid', 'Workspace panels', 'timeline'),
