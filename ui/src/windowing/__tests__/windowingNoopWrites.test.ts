...
describe('windowing no-op writes', () => {
  ...
  it('resizes docked panel pairs without touching floating geometry and skips identical writes', () => {
    ...
    expect(countRegistryNotifications(() => registry.resizeDockedPanelPair(
      'bottom',
      'timeline',
      320,
      'mixer',
