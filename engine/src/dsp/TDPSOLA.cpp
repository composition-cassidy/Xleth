...
// computeNSDF / detectPeriod / snapZeroCrossing / computeRMS and kSilenceRMS now
// live in dsp/LoopAnalysis.h, shared with the loop-analysis code. This block is
// the global anonymous namespace, so the names need pulling in explicitly.
using xleth::dsp::computeNSDF;
using xleth::dsp::detectPeriod;
using xleth::dsp::snapZeroCrossing;
